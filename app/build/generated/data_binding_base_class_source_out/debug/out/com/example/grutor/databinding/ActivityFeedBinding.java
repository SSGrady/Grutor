...
public final class ActivityFeedBinding implements ViewBinding {
  ...
  private ActivityFeedBinding(@NonNull RelativeLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull FrameLayout flContainer,
      @NonNull KonfettiView konfettiView, @NonNull RelativeLayout rlContainer) {
  ...
  public static ActivityFeedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFeedBinding((RelativeLayout) rootView, bottomNavigation, flContainer,
          konfettiView, rlContainer);
    }
